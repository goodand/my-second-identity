...
- source_context: `gangnam-1st` notebooks + `plans/codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md`
...
| `../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md` | 논문 19편 + 참고 URL 33개 — 실험 티켓 단일 레퍼런스 | [→](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md) |
...
| `../codex/docs/notes/MASTER_SUMMARY.md` | 워크스페이스 전체 P0/P1/P2 리스크 진단 | [→](../codex/docs/notes/MASTER_SUMMARY.md) |

**추천 읽기 순서:** PLAN.md → [KB](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md) (실험 근거) → [Diagrams](IMAGE_STRUCTURE_GRAPHS.md) (시각 구조) → [MASTER_SUMMARY](../codex/docs/notes/MASTER_SUMMARY.md) (운영 리스크)
...
- see_also: 논문 [#06 RAG 기초 공식화](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) · 운영 리스크 [MASTER_SUMMARY §P1](../codex/docs/notes/MASTER_SUMMARY.md#p1-이번-주)

2. Evaluation Harness
- 휴리스틱 + ROUGE/BLEU + String/Embedding distance + LLM-as-Judge + RAGAS 통합
- Hard fail + 품질 임계치 + 비용/지연 임계치 게이트 설정
- 슬라이스 리포트(질문유형/길이/도메인)
- see_also: 논문 [#04 RAG Survey](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) · [#02 Lost in the Middle](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) · 다이어그램 [#08 평가 파이프라인](IMAGE_STRUCTURE_GRAPHS.md#08-rag-evaluationbenchmark-pipeline)
...
- see_also: 논문 [#01 HyDE](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) · [#05 DMQR-RAG](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) · 다이어그램 [#03 Multi-Query](IMAGE_STRUCTURE_GRAPHS.md#03-multi-query--rag-fusion--dmqr-rag) · [#04 HyDE](IMAGE_STRUCTURE_GRAPHS.md#04-hyde) · [#05–07](IMAGE_STRUCTURE_GRAPHS.md#05-query-decomposition)
...
- see_also: 논문 [#03 Self-RAG](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) · [#07 FiD](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) · [#08 CRAG](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls)

5. Ops and Continuous Improvement
- CI: PR마다 오프라인 평가 + baseline delta 검사
- 온라인: trace 샘플링 + 주간 리포트
- 릴리즈: 평가 통과 시 배포, 회귀 시 롤백
- see_also: [MASTER_SUMMARY §P2](../codex/docs/notes/MASTER_SUMMARY.md#p2-다음-스프린트)

## 8-Agent Operation Plan
- A01: Query expansion/HyDE/MultiQuery 개선 트랙 · see_also: KB [#01](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) [#05](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) · Diagrams [#03](IMAGE_STRUCTURE_GRAPHS.md#03-multi-query--rag-fusion--dmqr-rag) [#04](IMAGE_STRUCTURE_GRAPHS.md#04-hyde) [#05](IMAGE_STRUCTURE_GRAPHS.md#05-query-decomposition) [#06](IMAGE_STRUCTURE_GRAPHS.md#06-query-rewrite-trainable-rewrite-retrieve-read) [#07](IMAGE_STRUCTURE_GRAPHS.md#07-step-back-prompting)
- A02: Evaluation 지표/벤치마크 트랙 · see_also: KB [#04](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) [#02](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls) · Diagram [#08](IMAGE_STRUCTURE_GRAPHS.md#08-rag-evaluationbenchmark-pipeline)
- A03: Rerank/Compression 트랙 · see_also: KB [#07 FiD](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#paper-like-urls)
...
- A05: 도메인 데이터 소스 트랙 · see_also: KB [Other URLs §ETF](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#other-rag-references-urls)
- A06: 멀티모달/반정형 트랙 · see_also: Diagram [#01 CLIP](IMAGE_STRUCTURE_GRAPHS.md#01-clip-contrastive-pre-training)
- A07: Tooling/SDK/LangSmith 트랙 · see_also: KB [Other URLs §LangSmith](../codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md#other-rag-references-urls)
...
## Backlog Source
- `plans/codex/docs/knowledge/RAG_URL_KNOWLEDGE_BASE.md`를 실험 티켓의 단일 레퍼런스로 사용
